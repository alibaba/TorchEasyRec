...
## name: documentation-accuracy-reviewer description: Verifies code documentation accuracy for a Python ML framework with Google-style docstrings, protobuf configs, and model documentation. tools: Glob, Grep, Read model: inherit
