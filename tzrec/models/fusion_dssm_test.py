...
from tzrec.models.fusion_dssm import FusionDSSM
...
class FusionDSSMTest(unittest.TestCase):
    ...
    def test_fusion_dssm(self, graph_type, use_senet=False, perm_feat=False) -> None:
        feature_cfgs = [
        ...
        model_config = model_pb2.ModelConfig(
            ...
            fusion_dssm=match_model_pb2.FusionDSSM(
                user_tower=[
                    tower_pb2.Tower(
        ...
        if perm_feat:
            model_config.fusion_dssm.user_tower_perm_feat.append(
