...
- Keep user-facing docs (Chinese belongs in `docs/`) focused on configuration, operation, observable behavior, and troubleshooting; place internal artifact layouts and implementation contracts beside the code that enforces them.
