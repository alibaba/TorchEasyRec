...
class MMoETest(unittest.TestCase):
    ...
    def test_mmoe(self, graph_type) -> None:
        feature_cfgs = [
        ...
        mmoe = MMoE(model_config=model_config, features=features, labels=["label"])
    ...
    def test_mmoe_has_sequnces(self, graph_type) -> None:
        feature_cfgs = [
            feature_pb2.FeatureConfig(
                id_feature=feature_pb2.IdFeature(
                    feature_name="cat_a", embedding_dim=16, num_buckets=100
