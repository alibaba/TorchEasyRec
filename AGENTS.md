...
- Keep user-facing docs focused on configuration, operation, observable behavior, and troubleshooting; Chinese-language content belongs in `docs/`. Place internal artifact layouts and implementation contracts beside the code that enforces them.
