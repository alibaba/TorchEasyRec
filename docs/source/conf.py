...
latex_documents = [
    (master_doc, "tzrec.tex", "TorchEasyRec Documentation", "EasyRec Team", "manual"),
]
...
man_pages = [(master_doc, "tzrec", "TorchEasyRec Documentation", [author], 1)]
